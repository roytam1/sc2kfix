...
void InstallMiscHooks(void) {
	...
	*(DWORD*)0x480C7B = 262144;
	...
	if (hGameMenu) {
		...
		afxMessageMapEntry[0].nID = IDM_GAME_OPTIONS_SC2KFIXSETTINGS;
		afxMessageMapEntry[0].nLastID = IDM_GAME_OPTIONS_SC2KFIXSETTINGS;
...
skipgamemenu:
	...
	if (hDebugMenu) {
		...
		afxMessageMapEntry[0].nMessage = WM_COMMAND;
		afxMessageMapEntry[0].nCode = 0;
		afxMessageMapEntry[0].nID = IDM_DEBUG_MILITARY_DECLINED;
		afxMessageMapEntry[0].nLastID = IDM_DEBUG_MILITARY_DECLINED;
		afxMessageMapEntry[0].nSig = 0x0A;
		afxMessageMapEntry[0].pfn = ProposeMilitaryBaseDecline;


		afxMessageMapEntry[1].nMessage = WM_COMMAND;
		afxMessageMapEntry[1].nCode = 0;
		afxMessageMapEntry[1].nID = IDM_DEBUG_MILITARY_AIRFORCE;
		afxMessageMapEntry[1].nLastID = IDM_DEBUG_MILITARY_AIRFORCE;
		afxMessageMapEntry[1].nSig = 0x0A;
		afxMessageMapEntry[1].pfn = ProposeMilitaryBaseAirForceBase;

		afxMessageMapEntry[2].nMessage = WM_COMMAND;
		afxMessageMapEntry[2].nCode = 0;
		afxMessageMapEntry[2].nID = IDM_DEBUG_MILITARY_ARMYBASE;
		afxMessageMapEntry[2].nLastID = IDM_DEBUG_MILITARY_ARMYBASE;
		afxMessageMapEntry[2].nSig = 0x0A;
		afxMessageMapEntry[2].pfn = ProposeMilitaryBaseArmyBase;

		afxMessageMapEntry[3].nMessage = WM_COMMAND;
		afxMessageMapEntry[3].nCode = 0;
		afxMessageMapEntry[3].nID = IDM_DEBUG_MILITARY_NAVALYARD;
		afxMessageMapEntry[3].nLastID = IDM_DEBUG_MILITARY_NAVALYARD;
		afxMessageMapEntry[3].nSig = 0x0A;
		afxMessageMapEntry[3].pfn = ProposeMilitaryBaseNavalYard;

		afxMessageMapEntry[4].nMessage = WM_COMMAND;
		afxMessageMapEntry[4].nCode = 0;
		afxMessageMapEntry[4].nID = IDM_DEBUG_MILITARY_MISSILESILOS;
		afxMessageMapEntry[4].nLastID = IDM_DEBUG_MILITARY_MISSILESILOS;
		afxMessageMapEntry[4].nSig = 0x0A;
		afxMessageMapEntry[4].pfn = ProposeMilitaryBaseMissileSilos;
